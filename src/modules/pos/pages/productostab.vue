          ...
          >
            <template #body="props">
              <q-tr
                :props="props"
                class="catalogo-row"
                @click="seleccionarProducto2(props.row)"
              >
                <!-- Código del producto -->
                <q-td key="codigo">
                ...
                <q-td key="precio">
                  <div
                    ...
                    "
                    class="text-subtitle1 text-grey text-strike"
                  >
                ...
                <q-td key="precioOferta">
                  ...
                  >
                    <span
                      class="text-positive text-subtitle1 text-weight-bold bg-green-1 q-px-md q-py-xs rounded-borders"
                    >
                    ...
                    >
                      Vigente al
                      {{
                        new Date(props.row.FECHA_VIGENCIA_F).toLocaleDateString(
                          "es-GT",
                ...
                <q-td key="niveles">
                  <div class="column items-start q-gutter-xs">
                    <q-chip
                      v-for="(nivel, index) in props.row.niveles"
                      :key="index"
                      dense
                      size="md"
                      text-color="black-10"
...
const productosUnicos = computed(() => {
  ...
  for (const prod of todosProductos.value) {
    ...
    const nivelTexto = `Q ${prod.PRECIO_FINAL.toFixed(2)} ( ${
      prod.CANTIDAD_INICIAL
    } a ${prod.CANTIDAD_FINAL} )`;
