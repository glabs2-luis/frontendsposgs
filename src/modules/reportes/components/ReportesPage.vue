                ...
                <div v-if="listaFacturas.length" class="ticket-container">
                  ...
                  <div ref="ticketRef" class="ticket-preview">
                    ...
                    <div class="ticket-fecha">
                      ...
                      <template v-if="rangoFechas.to && rangoFechas.to !== rangoFechas.from">
                    ...
                    <table class="ticket-tabla">
                      ...
                      <tbody>
                        <tr v-for="(factura, index) in listaFacturas" :key="index">
                          <td>{{ factura.SERIE }}</td>
                          <td>{{ factura.NUMERO_FACTURA }}</td>
                          <td>Q. {{ factura.TOTAL_GENERAL.toFixed(2) }}</td>
                          <td>Q. {{ factura.MONTO_DESCUENTO_FACT.toFixed(2) }}</td>
                        </tr>
                      </tbody>
                    </table>
